...
code_dir = "C:\\Users\\jajohns\\Files\\Publishing\\open_principles_of_microeconomics\\open_principles_of_microeconomics_dev"
doctomd_dir = os.path.join(code_dir, "doctomd")
media_dir = os.path.join(doctomd_dir, "media")
target_dir = os.path.join(code_dir, "QMD_open_principles_of_microeconomics")
