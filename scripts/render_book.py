...
conda_env_name = 'env2023a'
conda_env_path = 'C:/Users/jajohns/mambaforge/envs/'+conda_env_name+'/python.exe'
...
if render_book:  
    ...
    if render_whole_book:
        ...
        src_path = 'index.pdf'
        pdf_book_name = 'Open_Principles_of_Microeconomics'
        ...
        ### WARNING!!! This will not update the navigation of a book, so won't work if new/deleted fields happen
