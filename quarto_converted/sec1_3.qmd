...
```{r fig.align='center', fig.cap='**John Maynard Keynes** One of the most influential economists in modern times was John Maynard Keynes. (Credit: “John Maynard Keynes” by IMF/Wikimedia Commons, Public Domain)'}
#| echo: FALSE
#| label: fig-1_6
knitr::include_graphics("images/sec1_3_fig1_6.png")
```
