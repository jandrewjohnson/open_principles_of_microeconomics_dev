# Chapter 4 - Labor and Financial Markets {#sec-chapter-4}
![](media/4-introduction-to-labor-and-financial-markets_rId20.jpeg){width="6.5in" height="3.933333333333333in" #fig-4_1}
...
4.2](#fig-4_2) illustrates how demand and supply determine
equilibrium in this labor market. The demand and supply schedules in
@tbl-table_4_1 list the quantity supplied and quantity
demanded of nurses at different salaries.



![](media/4-1-demand-and-supply-at-work-in-labor-markets_rId24.jpeg){width="4.88in" height="2.68in" #fig-4_2}
...
: Demand and Supply of Nurses in Minneapolis-St.
Paul-Bloomington {#tbl-table_4_1}
...
4.2](#fig-4_2), the supply curve (S) and demand curve (D)
...
demand for labor will decrease, or shift to the left. @tbl-table_4_2 shows that in addition to the derived demand for
...
: Factors That Can Shift Demand {#tbl-table_4_2}

#### Link It Up {#link-it-up .Heading3Grey}

Click [here](https://www.bls.gov/careeroutlook/2000/Summer/art04.pdf) to read more about
...
more labor is willing to work and forego leisure activities. @tbl-table_4_3 lists some of the factors that will cause the supply
...
: Factors that Can Shift Supply {#tbl-table_4_3}
...
4.3](#CNX_Econ_C04_009) (a) and [Figure 4.3](#fig-4_3) (b),
...
![](media/4-1-demand-and-supply-at-work-in-labor-markets_rId39.jpeg){width="6.5in" height="2.855in" #fig-4_3}
...
Visit this [website](https://readwrite.com/10-technology-skills-no-longer-in-demand/#awesm=~og2BuP53pqBEMo) to read about
...
[Figure 4.4](#fig-4_4) illustrates the situation of a city
...
life has not improved. @tbl-table_4_4 shows the differences
in supply and demand at different wages.

![](media/4-1-demand-and-supply-at-work-in-labor-markets_rId48.jpeg){width="3.25in" height="2.49in" #fig-4_4}
...
: Living Wage: Example of a Price Floor {#tbl-table_4_4}
...
policy options for helping low-wage workers. (The @sec-chapter-15 discusses some possibilities.) The lesson from this maze of
...
financial investments like bank accounts, stocks and bonds, see @sec-chapter-17.
...
[Figure 4.5](#fig-4_5) illustrates demand and supply in the
...
of credit card borrowing we can measure with an interest rate. @tbl-table_4_5 shows the quantity of financial capital that
consumers demand at various interest rates and the quantity that credit
card firms (often banks) are willing to supply.

![](media/4-2-demand-and-supply-in-financial-markets_rId25.jpeg){width="4.88in" height="2.53in" #fig-4_5}
...
: Demand and Supply for Borrowing Money with Credit Cards {#tbl-table_4_5}
...
4.5](#fig-4_5), the supply curve (S) and the demand curve (D)
...
[website](https://fred.stlouisfed.org/categories/22).
...
pouring money into the U.S. economy. [Figure 4.6](#fig-4_6)
...
![](media/4-2-demand-and-supply-in-financial-markets_rId37.jpeg){width="3.25in" height="2.535in" #fig-4_6}
...
4.7](#fig-4_7) shows the supply curve shift from S~0~ to S~1~.

![](media/4-2-demand-and-supply-in-financial-markets_rId40.jpeg){width="3.25in" height="2.535in" #fig-4_7}
...
Consider the credit card market as [Figure 4.8](#fig-4_8)
...
R~c~ in [Figure 4.8](#fig-4_8) shows the price ceiling. The
...
![](media/4-2-demand-and-supply-in-financial-markets_rId46.jpeg){width="3.25in" height="2.52in" #fig-4_8}
...
course. (The opportunity set model that we introduced in the @sec-chapter-2 was the first.) Just as it would be foolish to try to learn the
...
[Figure 4.9](#fig-4_9) displays a generic demand and supply
...
![](media/4-3-the-market-system-as-an-efficient-mechanism-for-information_rId24.jpeg){width="3.25in" height="2.785in" #fig-4_9}
...
4.10](#fig-4_10) shows. The impact of that increase will result
...
![](media/4-3-the-market-system-as-an-efficient-mechanism-for-information_rId29.jpeg){width="3.25in" height="2.535in" #fig-4_10}
...
in [Figure 4.11](#fig-4_11) captures the impact of a decreasing
...
![](media/4-3-the-market-system-as-an-efficient-mechanism-for-information_rId32.jpeg){width="3.25in" height="2.535in" #fig-4_11}

Figure 4.11 Impact of Decreasing Supply of Nurses between 2020 and 2030
The increase in demand for nurses shown in [Figure 4.10](#fig-4_10) leads to both
