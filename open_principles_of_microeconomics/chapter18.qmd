# Chapter 18 - Public Economy {#sec-chapter-18}
![](media/18-introduction-to-public-economy_rId20.jpeg){width="6.5in" height="3.875in" #fig-18_1}
...
Visit this [website](https://www.pewresearch.org/short-reads/2020/11/06/2020-election-reveals-two-broad-voting-coalitions-fundamentally-at-odds/) to see a
...
in politics to an issue we raised in @sec-chapter-12
...
Visit this [website](https://www.opensecrets.org/federal-lobbying) to read about
lobbying.
...
once, compare them two at a time. (See [Figure 18.2](#fig-18_2))
...
![](media/18-3-flaws-in-the-democratic-system-of-government_rId25.jpeg){width="3.25in" height="2.69in" #fig-18_2}
...
: Circular Preferences {#tbl-table_18_1}
...
total surplus in the @sec-chapter-3
chapter, and tariffs in the @sec-chapter-19.) Instead of saving jobs, it cost jobs, and those jobs that it
