# Chapter 10 - Monopolistic Competition and Oligopoly {#sec-chapter-10}
![](media/10-introduction-to-monopolistic-competition-and-oligopoly_rId20.jpeg){width="6.5in" height="4.116666666666666in" #fig-10_1}
...
prominent Keynesian, and later a post-Keynesian economist. (See @sec-chapter-1
for more on Keynes.)
...
10.2](#fig-10_2) offers a reminder that the demand curve that a
...
![](media/10-1-monopolistic-competition_rId33.jpeg){width="6.5in" height="2.305in" #fig-10_2}
...
demand curve is downward sloping, as [Figure 10.3](#fig-10_3)
shows and the first two columns of @tbl-table_10_1.

![](media/10-1-monopolistic-competition_rId40.jpeg){width="4.88in" height="2.755in" #fig-10_3}
...
: 10.1 Revenue and Cost Schedule {#tbl-table_10_1}
...
receive, which is in the third column of @tbl-table_10_1. We
calculate marginal revenue, in the fourth column, as the change in total
revenue divided by the change in quantity. The final columns of @tbl-table_10_1 show total cost, marginal cost, and average cost. As
...
making economic profits. From @tbl-table_10_1 we can see
that, at an output of 40, the firm's total revenue is \$640 and its
total cost is \$580, so profits are \$60. In [Figure
10.3](#fig-10_3), the firm's total revenues are the rectangle
...
[Figure 10.4](#fig-10_4) (a) shows a situation in which a
...
![](media/10-1-monopolistic-competition_rId47.jpeg){width="6.5in" height="2.68in" #fig-10_4}
...
10.4](#fig-10_4) (b) shows the reverse situation, where a
...
The game theory situation facing the two prisoners is in @tbl-table_10_2. To understand the dilemma, first consider the
...
|                  | Prisoner B - Remain Silent (Cooperate)   | Prisoner B - Confess (Do Not Cooperate)  |
|------------------|-----------------------------------------|-------------------------------------------|
| **Prisoner A - Remain Silent (Cooperate)**   | A gets 2 years, B gets 2 years             | A gets 8 years, B gets 1 year              |
| **Prisoner A - Confess (Do Not Cooperate)**   | A gets 1 year, B gets 8 years             | A gets 5 years, B gets 5 years             |

: The Prisoner's Dilemma Problem {#tbl-table_10_2}
...
of the high price by raising output and earning higher profits. @tbl-table_10_3 shows the prisoner's dilemma for a two-firm
...
|                  | Firm B - Hold Down Output (Cooperate)   | Firm B - Increase Output (Do Not Cooperate)  |
|------------------|-----------------------------------------|----------------------------------------------|
| **Firm A - Hold Down Output (Cooperate)**   | A gets $1,000, B gets $1,000               | A gets $200, B gets $1,500                  |
| **Firm A - Increase Output (Do Not Cooperate)**   | A gets $1,500, B gets $200               | A gets $400, B gets $400                    |

: A Prisoner's Dilemma for Oligopolists {#tbl-table_10_3}
...
-   If A thinks that B will cheat on their agreement and increase
    ...
    choice in @tbl-table_10_3) is better than a profit of
...
[website](https://www.opec.org/opec_web/en/about_us/24.htm) and learn more about its history
...
price cuts, but not price increases. [Figure 10.5](#fig-10_5)
...
![](media/10-2-oligopoly_rId51.jpeg){width="3.25in" height="2.465in" #fig-10_5}
...
benefit to consumers. @sec-chapter-11
