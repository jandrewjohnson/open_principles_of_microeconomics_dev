# Chapter 6 - Consumer Choices {#sec-chapter-6}
![](media/6-introduction-to-consumer-choices_rId20.jpeg){width="6.5in" height="3.6999989063867016in" #fig-6_1}
...
introduced in the @sec-chapter-2
...
incomes. After reading this chapter, consult @sec-appendix-b
...
Statistics. @tbl-table_6_1 shows spending patterns for the
...
: U.S. Consumption Choices in 2015 (Source:http://www.bls.gov/cex/csxann13.pdf) {#tbl-table_6_1}
...
shown in [Figure 6.2](#fig-6_2). José likes to collect T-shirts
and watch movies.

In [Figure 6.2](#fig-6_2) we show the quantity of T-shirts on
...
![](media/6-1-consumption-choices_rId26.jpeg){width="4.88in" height="2.505in" #fig-6_2}
...
the same as the way someone else does.) @tbl-table_6_2 shows
...
learned earlier in @sec-chapter-2.

The rest of @tbl-table_6_2 shows the quantity of movies that
...
: Total and Marginal Utility {#tbl-table_6_2}

@tbl-table_6_3 looks at each point on the budget constraint
in [Figure 6.2](#fig-6_2), and adds up José's total utility for
...
: Finding the Choice with the Highest Utility {#tbl-table_6_3}
...
Step 2. Look at @tbl-table_6_3. You can see from the fourth
...
Step 4. You can repeat the same calculations for each point on @tbl-table_6_3, in which the total utility numbers are shown in the
last column.
...
T-shirts and no movies, as [Figure 6.2](#fig-6_2) illustrates.
...
movies instead. @tbl-table_6_4 tracks the step-by-step series
...
| Choice 3: R | 2 T-shirts and 4 movies        | 43 from 2 T-shirts + 58 from 4 movies = 101           | Loss of 20 from 1 less T-shirt, but gain of 27 from 2 more movies, for a net utility gain of 7     | R is preferred over Q         |
| Choice 4: S | 1 T-shirt and 6 movies         | 22 from 1 T-shirt + 81 from 6 movies = 103            | Loss of 21 from 1 less T-shirt, but gain of 23 from 2 more movies, for a net utility gain of 2      | S is preferred over R         |
| Choice 5: T | 0 T-shirts and 8 movies         | 0 from 0 T-shirts + 100 from 8 movies = 100           | Loss of 22 from 1 less T-shirt, but gain of 19 from 2 more movies, for a net utility loss of 3     | S is preferred over T         |

: A Step-by-Step Approach to Maximizing Utility {#tbl-table_6_4}
...
Step 1. From @tbl-table_6_2, José can see that the marginal
...
to the last column in @tbl-table_6_3) is 13 more than the
...
price. @tbl-table_6_5 shows the marginal utility per dollar
...
: Marginal Utility per Dollar {#tbl-table_6_5}
...
The general rule, $\frac{\mathrm{MU}_1}{\mathrm{P}_1}=\frac{\mathrm{MU}_2}{\mathrm{P}_2}$, means that the last dollar spent on
...
Step 4. Choice 4 in @tbl-table_6_4 shows that if we move to
...
level affect consumer choices. [Figure 6.3](#fig-6_3) shows a
...
![](media/6-2-how-changes-in-income-and-prices-affect-consumption-choices_rId23.jpeg){width="3.25in" height="2.535in" #fig-6_3}
...
is to purchase less of both goods. As we defined in @sec-chapter-3
and again in @sec-chapter-5,
...
let's again use a concrete example. [Figure 6.4](#fig-6_4)
...
![](media/6-2-how-changes-in-income-and-prices-affect-consumption-choices_rId33.jpeg){width="4.88in" height="2.295in" #fig-6_4}
...
consumption to fall? [Figure 6.4](#fig-6_4) suggests a range of
...
Read this [article](https://www.nytimes.com/1999/10/28/business/variable-price-coke-machine-being-tested.html) about the potential
...
utility. [Figure 6.5](#fig-6_5) (a) shows a budget constraint
...
![](media/6-2-how-changes-in-income-and-prices-affect-consumption-choices_rId42.jpeg){width="3.25in" height="5.085in" #fig-6_5}
...
Q~2~ to Q~3~---on the demand curve in [Figure 6.5](#fig-6_5)
(b). The vertical dashed lines stretching between the top and bottom of
[Figure 6.5](#fig-6_5) show that the quantity of housing
...
as [Figure 6.6](#fig-6_6) shows. They show a positive
...
![](media/6-3-behavioral-economics-an-alternative-framework-for-consumer-choice_rId25.jpeg){width="6.36in" height="3.275in" #fig-6_6}
