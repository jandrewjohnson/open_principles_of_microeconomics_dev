# Chapter 8 - Perfect Competition {#sec-chapter-8}
![](media/8-introduction-to-perfect-competition_rId20.jpeg){width="6.5in" height="4.335in" #fig-8_1}
...
Visit this [website](https://www.cnn.com/markets) that reveals the
...
costs as we discussed in @sec-chapter-7.
...
@tbl-table_8_1 shows total revenue and total costs for
the raspberry farm; these data also appear in [Figure
8.2](#fig-8_2). The horizontal axis shows the quantity of
...
same characteristics as the curves that we covered in @sec-chapter-7.

![](media/8-2-how-perfectly-competitive-firms-make-output-decisions_rId29.jpeg){width="4.88in" height="2.435in" #fig-8_2}
...
: Total Cost and Total Revenue at the Raspberry Farm {#tbl-table_8_1}
...
8.2](#fig-8_2) shows total revenue, total cost and profit using
the data from @tbl-table_8_1. The vertical gap between
...
in the final column of @tbl-table_8_1. Maximum profit
...
[Figure 8.3](#fig-8_3) presents the marginal revenue and
marginal cost curves based on the total revenue and total cost in @tbl-table_8_1. The marginal revenue curve shows the additional
...
firm's revenue increases by \$4. @tbl-table_8_2 shows an
...
: Marginal Revenue for a Price-Taking Firm {#tbl-table_8_2}
...
In the raspberry farm example, in [Figure 8.3](#fig-8_3) and
@tbl-table_8_3, marginal cost at first declines as
...
![](media/8-2-how-perfectly-competitive-firms-make-output-decisions_rId38.jpeg){width="4.88in" height="2.605in" #fig-8_3}
...
8.4](#fig-8_4) illustrates. The marginal cost (MC) curve is
...
![](media/8-2-how-perfectly-competitive-firms-make-output-decisions_rId41.jpeg){width="4.88in" height="2.655in" #fig-8_4}
...
: Marginal Revenues and Marginal Costs at the Raspberry Farm {#tbl-table_8_3}
...
@tbl-table_8_1 shows that maximum profit occurs at any
...
to produce for a while and incur a loss. @tbl-table_8_3
continues the raspberry farm example. [Figure 8.5](#fig-8_5)
...
![](media/8-2-how-perfectly-competitive-firms-make-output-decisions_rId49.jpeg){width="6.5in" height="5.935in" #fig-8_5}
...
which is labeled as E\' in [Figure 8.5](#fig-8_5) (a). Remember
...
Now consider [Figure 8.5](#fig-8_5) (b), where the price has
...
In [Figure 8.5](#fig-8_5) (c), the market price has fallen
...
losses. @tbl-table_8_4 summarizes this.
...
: Summary of Profit Conditions for a Perfectly Competitive Firm {#tbl-table_8_4}
...
rent, but it would not need to hire labor. @tbl-table_8_5
...
: Should the Yoga Center Shut Down Now or Later? {#tbl-table_8_5}

[Figure 8.6](#fig-8_6) illustrates the lesson that remaining
...
price declined to \$1.50 per pack, as [Figure 8.6](#fig-8_6)
...
![](media/8-2-how-perfectly-competitive-firms-make-output-decisions_rId74.jpeg){width="6.5in" height="2.73in" #fig-8_6}
...
Looking at @tbl-table_8_6, if the price falls below about
...
: Cost of Production for the Raspberry Farm {#tbl-table_8_6}
...
cost curve into three segments, as [Figure 8.7](#fig-8_7)
...
![](media/8-2-how-perfectly-competitive-firms-make-output-decisions_rId79.jpeg){width="4.88in" height="3.38in" #fig-8_7}
...
Watch this [video](https://www.pbs.org/video/pbs-newshour-food-prices-rise-across-the-us-due-to-drought/) that addresses how
drought in the United States can impact food prices across the world.

As we discussed in @sec-chapter-3,
...
competition, follow the steps outlined below. Use the data in @tbl-table_8_7.
...
: Data for the Firm in Perfect Competition {#tbl-table_8_7}
...
in the @sec-chapter-7
chapter. These calculations are in @tbl-table_8_8.
...
: Calculations for the Firm in Perfect Competition {#tbl-table_8_8}
...
: Total Revenue for the Firm in Perfect Competition {#tbl-table_8_9}

Step 3. Calculate profits as total cost subtracted from total revenue,
as @tbl-table_8_10 shows.
...
: Profits for the Firm in Perfect Competition {#tbl-table_8_10}

Step 4. To find the profit-maximizing output level, look at the Marginal
Cost column (at every output level produced), as @tbl-table_8_11 shows, and determine where it is equal to the
...
: Marginal Cost for the Firm in Perfect Competition {#tbl-table_8_11}
...
[Figure 8.8](#fig-8_8) (a) presents the case of an adjustment
...
a flat curve. [Figure 8.8](#fig-8_8) (b) and [Figure
8.8](#fig-8_8) (c) present the cases for an increasing cost and
...
![](media/8-3-entry-and-exit-decisions-in-the-long-run_rId32.jpeg){width="6.5in" height="1.98in" #fig-8_8}
...
A quick glance at @tbl-table_8_12 reveals the dramatic
...
: Corn Acreage in North Dakota {#tbl-table_8_12}
