# Present Discounted Value {#sec-appendix-c}

As explained in @sec-chapter-17,
...
@tbl-table_append_c_1 shows how to calculate the present discounted
...
: Calculating Present Discounted Value of a Stock {#tbl-table_append_c_1}
...
A similar calculation works in the case of bonds. @sec-chapter-17
...
present value formula are shown in @tbl-table_append_c_2.
...
: Computing the Present Discounted Value of a Bond {#tbl-table_append_c_2}
