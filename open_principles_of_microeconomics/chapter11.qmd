# Chapter 11 - Monopoly and Antitrust Policy {#sec-chapter-11}
![](media/11-introduction-to-monopoly-and-antitrust-policy_rId20.jpeg){width="6.5in" height="2.6666666666666665in" #fig-11_1}
...
The left-hand panel of [Figure 11.2](#fig-11_2) (a) shows the
...
11.2](#fig-11_2) (b) shows the distribution of those mergers
...
![](media/11-1-corporate-mergers_rId24.jpeg){width="6.5in" height="2.827823709536308in" #fig-11_2}
...
inefficiencies in an economy, refer to @sec-chapter-9.

Say that the market for replacing broken automobile windshields in a
certain city has 18 firms with the market shares in @tbl-table_11_1, where the market share is each firm's proportion of
...
| Seven firms (each with 6%)            | 42% of the market, combined            |
| Eight firms (each with 3%)            | 24% of the market, combined            |
| Then the four-firm concentration ratio | 16 + 10 + 8 + 6 = 40                  |

: Calculating Concentration Ratios from Market Shares {#tbl-table_11_1}
...
Visit this [website](https://business.time.com/2013/01/04/googles-federal-antitrust-deal-cheered-by-some-jeered-by-others/) to read an
...
Step 3. Calculate the HHI for the industry in @tbl-table_11_1. In this case, the HHI is 16^2^ + 10^2^ + 8^2^ +
7(6^2^) + 8(3^2^) = 744.
...
Step 7. Review @tbl-table_11_2 which gives some examples of
...
: Examples of Concentration Ratios and HHIs in the U.S.
Economy, 2016 {#tbl-table_11_2}
...
markets. For more on the difficulties of defining markets, refer to @sec-chapter-9.
...
[Figure 11.3](#fig-11_3) illustrates the case of natural
...
F illustrate four of the main choices for regulation. @tbl-table_11_3 outlines the regulatory choices for dealing with a
natural monopoly.

![](media/11-3-regulating-natural-monopolies_rId24.jpeg){width="3.25in" height="2.5in" #fig-11_3}
...
: Regulatory Choices in Dealing with Natural Monopoly (\*We
...
11.3](#fig-11_3). They calculated the average cost of production
...
that we discussed in @sec-chapter-9 ---removing
