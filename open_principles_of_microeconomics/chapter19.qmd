# Chapter 19 - International Trade {#sec-chapter-19}
![](media/19-introduction-to-international-trade_rId20.jpeg){width="6.5in" height="3.9166666666666665in" #fig-19_1}
...
Visit this [website](https://www.wto.org/english/forums_e/debates_e/debates_e.htm) for a list of articles
...
fewer resources. @tbl-table_19_1 illustrates the advantages
...
: How Many Hours It Takes to Produce Oil and Corn {#tbl-table_19_1}

In @tbl-table_19_1, Saudi Arabia has an absolute advantage in
...
100 worker hours (see @tbl-table_19_2). [Figure
19.2](#fig-19_2) illustrates what each country is capable of
producing on its own using a production possibility frontier (PPF)
graph. Recall from @sec-chapter-2
...
: Production Possibilities before Trade {#tbl-table_19_2}

![](media/19-1-absolute-and-comparative-advantage_rId30.jpeg){width="6.5in" height="2.625in" #fig-19_2}
...
using the data in @tbl-table_19_1. (b) If the United States
...
devote 60 worker hours to produce oil, as @tbl-table_19_3
shows. Given the information in @tbl-table_19_1, this choice
...
: Production before Trade {#tbl-table_19_3}
...
@tbl-table_19_4 summarizes these calculations.
...
: Opportunity Cost and Comparative Advantage {#tbl-table_19_4}
...
@tbl-table_19_4) it has a comparative advantage in oil
...
(absolute advantage, see @tbl-table_19_1), and also gives up
the least in terms of other goods to produce oil (comparative advantage,
see @tbl-table_19_4). Such symmetry is not always the case,
...
When you first met the production possibility frontier (PPF) in @sec-chapter-2,
...
specialization and trade. (Recall that @sec-chapter-1
...
specialization and trade. @tbl-table_19_5 illustrates the
...
: The Range of Trades That Benefit Both the United States and Saudi Arabia {#tbl-table_19_5}
...
comparative advantage and specialization? @tbl-table_19_6
...
production. (Compare the total world production in @tbl-table_19_3 to that in @tbl-table_19_6.)
...
: How Specialization Expands Output {#tbl-table_19_6}

What if we did not have complete specialization, as in @tbl-table_19_6? Would there still be gains from trade? Consider
another example, such as when the United States and Saudi Arabia start
at C and C\', respectively, as [Figure 19.2](#fig-19_2) shows.
...
![](media/19-1-absolute-and-comparative-advantage_rId40.jpeg){width="4.875in" height="3.7399989063867016in" #fig-19_3}
...
consumption has increased to 30 (see [Figure 19.3](#fig-19_3)).
...
described in @tbl-table_19_7. In this example, it takes four
...
: Resources Needed to Produce Shoes and Refrigerators {#tbl-table_19_7}
...
workers. For example, as @tbl-table_19_8 shows, if the United
...
: Production Possibilities before Trade with Complete Specialization {#tbl-table_19_8}
...
producing the former (see [Figure 19.4](#fig-19_4)).

![](media/19-2-what-happens-when-a-country-has-an-absolute-advantage-in-all-goods_rId25.jpeg){width="6.5in" height="2.835in" #fig-19_4}
...
A. @tbl-table_19_9 shows the output of each good for each
...
: Total Production at Point A before Trade {#tbl-table_19_9}
...
production of both goods rises, as shown in @tbl-table_19_10.
...
: Shifting Production Toward Comparative Advantage Raises
Total Output {#tbl-table_19_10}
...
19.4](#fig-19_4) and @tbl-table_19_9). Then, in the
...
The range of trades that can benefit both nations is shown in @tbl-table_19_11. For example, a trade where the U.S. exports 4,000
...
: The Range of Trades That Benefit Both the United States and Mexico {#tbl-table_19_11}
...
: Production Possibilities in Canada and Venezuela {#tbl-table_19_12}
...
Step 1. Make a table like @tbl-table_19_12.
...
and Mexico (see @tbl-table_19_13).
...
: Top Trading Partners (November 2021) (Source:
https://www.census.gov/foreign-trade/statistics/highlights/toppartners.html) {#tbl-table_19_13}
...
autos and imports autos. @tbl-table_19_14 shows some of the
...
(Source: https://www.census.gov/foreign-trade/data/index.html) {#tbl-table_19_14}
...
Visit this [website](http://singaporeanipaduser.blogspot.com/2011/04/breakdown-of-iphone-components.html) for some
...
economies of scale, as we introduced in @sec-chapter-7,
means that as the scale of output goes up, average costs of production
decline---at least up to a point. [Figure 19.5](#fig-19_5)
...
![](media/19-3-intra-industry-trade-between-similar-economies_rId34.jpeg){width="3.25in" height="2.17in" #fig-19_5}
...
Visit this [website](https://www.ustr.gov/about-us/benefits-trade) for a list of
