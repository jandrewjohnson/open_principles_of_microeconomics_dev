# Chapter 15 - Poverty and Economic Inequality {#sec-chapter-15}
![](media/15-introduction-to-poverty-and-economic-inequality_rId20.jpeg){width="6.5in" height="3.275in" #fig-15_1}
...
[Figure 15.2](#fig-15_2) shows the U.S. poverty rate over time;
...
10.5% in 2019. @tbl-table_15_1 compares poverty rates for
...
Visit this [website](https://www.census.gov/library/publications/2021/demo/p60-273.html) for more
information on U.S. poverty.

![](media/15-1-drawing-the-poverty-line_rId30.jpeg){width="4.88in" height="2.71in" #fig-15_2}
...
: Poverty Rates by Group, 2020 {#tbl-table_15_1}
...
@tbl-table_15_2 shows. China and India both have more
...
: Poverty Lines for Low-Income Countries, mid-2000s (Source:
https://datatopics.worldbank.org/world-development-indicators/themes/poverty-and-inequality.html) {#tbl-table_15_2}
...
15.3](#fig-15_3) illustrates a single mother (earning \$8 an
...
\$1,000 of its support. @tbl-table_15_3 shows what will
happen at each combination of work and government support.

![](media/15-2-the-poverty-trap_rId25.jpeg){width="3.25in" height="2.795in" #fig-15_3}
...
: Total Income at Various Combinations of Work and Support {#tbl-table_15_3}
...
[Figure 15.4](#fig-15_4) illustrates a government program that
...
higher budget line in [Figure 15.4](#fig-15_4) shows that, with
...
set. @tbl-table_15_4 shows the total income differences
...
![](media/15-2-the-poverty-trap_rId28.jpeg){width="3.25in" height="3.225in" #fig-15_4}
...
: The Labor-Leisure Tradeoff with Assistance Reduced by 50
Cents for Every Dollar Earned {#tbl-table_15_4}
...
Visit this [website](https://www.youtube.com/watch?v=-4bk27lHqBo) to watch a
...
[Figure 15.5](#fig-15_5) illustrates that the earned income tax
...
![](media/15-3-the-safety-net_rId31.jpeg){width="4.88in" height="2.855in" #fig-15_5}
...
15.6](#fig-15_6)). According to the Office of Management and
...
![](media/15-3-the-safety-net_rId38.jpeg){width="4.239998906386702in" height="3.04in" #fig-15_6}
...
approximately 25% of participants. As [Figure 15.7](#fig-15_7)
...
[Figure 15.7](#fig-15_7) (b) shows how much actual Medicaid
...
![](media/15-3-the-safety-net_rId45.jpeg){width="6.5in" height="2.38in" #fig-15_7}
...
U.S. income distribution by quintile appears in @tbl-table_15_5. In 2020, for example, the bottom quintile of
...
and the top quintile, 52.2%. The final column of @tbl-table_15_5 shows what share of income went to households in
...
: Share of Aggregate Income Received by Each Fifth and Top 5%
of Households, 1967--2020 (Source: U.S. Census Bureau,
https://www.census.gov/data/tables/time-series/demo/income-poverty/historical-income-households.html,
Table H-1, All Races.) {#tbl-table_15_5}
...
insights. For example, the last column of @tbl-table_15_5
...
15.8](#fig-15_8) presents an alternative way of showing
...
![](media/15-4-income-inequality-measurement-and-causes_rId28.jpeg){width="3.25in" height="2.28in" #fig-15_8}
...
angle. We show it as a dashed line in [Figure 15.8](#fig-15_8).
...
third columns of numbers in @tbl-table_15_6, into
...
: Calculating the Lorenz Curve {#tbl-table_15_6}
...
[Figure 15.8](#fig-15_8) illustrates the greater inequality of
...
global standards. As @tbl-table_15_7 shows, based on a
...
: Income Distribution in Select Countries (Source: U.S. data
from U.S. Census Bureau Table H-1. Other data from The World Bank
Poverty and Inequality Data Base,
https://datatopics.worldbank.org/world-development-indicators/themes/poverty-and-inequality.html) {#tbl-table_15_7}

 

#### Link It Up {#link-it-up .Heading3Grey}

Visit this [website](https://www.youtube.com/watch?v=uWSxzjyMNpU) to watch a video
...
Visit this [website](https://www.youtube.com/watch?v=TOxuip4f7TQ) to watch a video
...
over 138%. In [Figure 15.9](#fig-15_9), this shift in supply to
...
![](media/15-4-income-inequality-measurement-and-causes_rId40.jpeg){width="4.88in" height="2.71in" #fig-15_9}
...
talents, and efforts. @tbl-table_15_8 shows some of
those initiatives.
...
: Public Policy Initiatives {#tbl-table_15_8}
...
[Figure 15.10](#fig-15_10) (a) shows. In this formulation, if
...
too pessimistic, and [Figure 15.10](#fig-15_10) (b) presents an
...
![](media/15-5-government-policies-to-reduce-income-inequality_rId36.jpeg){width="6.5in" height="2.495in" #fig-15_10}
...
The tradeoff in [Figure 15.10](#fig-15_10) (b) then flattens out
