# Chapter 9 - Monopoly {#sec-chapter-9}
![](media/9-introduction-to-a-monopoly_rId20.jpeg){width="6.5in" height="3.908333333333333in" #fig-9_1}
...
you might have read @sec-chapter-8.
...
competition. (We introduced this theme in @sec-chapter-7).
[Figure 9.2](#fig-9_2) presents a long-run average cost curve
...
![](media/9-1-how-monopolies-form-barriers-to-entry_rId26.jpeg){width="4.88in" height="3.325in" #fig-9_2}
...
Vist this [website](https://www.bpmlegal.com/content/weird) for examples of some
...
@tbl-table_9_1 lists the barriers to entry that we have
...
: Barriers to Entry {#tbl-table_9_1}
...
9.3](#fig-9_3) (a). The flat perceived demand curve means that,
...
![](media/9-2-how-a-profit-maximizing-monopoly-chooses-output-and-price_rId23.jpeg){width="6.5in" height="2.575in" #fig-9_3}
...
[Figure 9.3](#fig-9_3) illustrates this situation. The
...
HealthPill firm in [Figure 9.4](#fig-9_4). The total cost curve
has its typical shape that we learned about in @sec-chapter-7,
and that we used in @sec-chapter-8;
that is, total costs rise and the curve grows steeper as output
increases, as the final column of @tbl-table_9_2 shows.

![](media/9-2-how-a-profit-maximizing-monopoly-chooses-output-and-price_rId32.jpeg){width="4.88in" height="2.52in" #fig-9_4}
...
: Total Costs and Total Revenues of HealthPill {#tbl-table_9_2}
...
explore this using the data in @tbl-table_9_2, which shows
...
[Figure 9.4](#fig-9_4), the highest profit will occur at the
...
@tbl-table_9_3 expands @tbl-table_9_2 using the
...
revenue curves, as [Figure 9.5](#fig-9_5) shows.
...
![](media/9-2-how-a-profit-maximizing-monopoly-chooses-output-and-price_rId40.jpeg){width="4.88in" height="2.2249989063867015in" #fig-9_5}
...
: Costs and Revenues of HealthPill {#tbl-table_9_3}
...
For example, at an output of 4 in [Figure 9.5](#fig-9_5),
...
Step 2. Note that in @tbl-table_9_3, as output increases from
...
Step 4. Note that in @tbl-table_9_3, as output increases from
...
: Marginal Revenue, Marginal Cost, Marginal and Total Profit {#tbl-table_9_4}

@tbl-table_9_4 repeats the marginal cost and marginal revenue
data from @tbl-table_9_4, and adds two more columns: Marginal
...
be illustrated graphically with [Figure 9.6](#fig-9_6), which
...
demand curve. @tbl-table_9_5 shows the data for these curves.
...
: Demand, Marginal Revenue, Marginal Cost, and Average Cost for HealthPill {#tbl-table_9_5}

![](media/9-2-how-a-profit-maximizing-monopoly-chooses-output-and-price_rId55.jpeg){width="4.88in" height="3.02in" #fig-9_6}
...
HealthPill monopoly from [Figure 9.5](#fig-9_5). It then adds
...
[Figure 9.7](#fig-9_7) illustrates the three-step process where
...
marginal revenue. On [Figure 9.6](#fig-9_6), MR = MC occurs at
an output of 5.
...
9.6](#fig-9_6), is \$800. This price is above the average cost
...
9.6](#fig-9_6), this is 5 x \$800 = \$4000. In [Figure
9.6](#fig-9_6), the bottom part of the shaded box, which is
...
![](media/9-2-how-a-profit-maximizing-monopoly-chooses-output-and-price_rId58.jpeg){width="4.145in" height="2.605in" #fig-9_7}
...
![](media/9-2-how-a-profit-maximizing-monopoly-chooses-output-and-price_rId61.jpeg){width="3.25in" height="2.365in" #fig-9_8}
...
back at [Figure 9.6](#fig-9_6). Thus, consumers do not benefit
